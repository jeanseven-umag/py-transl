                ...
                <div class="card-body">
                    ...
                    <form id="addItem" action="">
                        ...
                        <div class="form-group">
                            ...
                            <input value="" name="eq_name" type="text" class="form-control" id="exampleFormControlInput1" placeholder="Введите название товара">
                        </div>
                        <div class="form-group">
                            <label for="exampleFormControlInput2">Цена</label>
                            <input value="" name="eq_price" type="text" class="form-control" id="exampleFormControlInput2" placeholder="Введите цену">
                        </div>
                        <div class="form-group">
                            <label for="exampleFormControlInput3">Скидка если есть</label>
                            <input value="" name="eq_sale" type="text`" class="form-control" id="exampleFormControlInput3" placeholder="Введите название товара">
                        ...
                        <div class="form-group">
                            ...
                            <input value="" name="eq_url" type="text" class="form-control" id="exampleFormControlInput4" placeholder="Введите url">
                        ...
                        <div class="form-group">
                            ...
                            <input value="" name="eq_video" type="text" class="form-control" id="exampleFormControlInput5" placeholder="Введите id video">
                        ...
                        <div class="form-group">
                            ...
                            <input value="" name="eq_image" type="text" class="form-control" id="exampleFormControlInput6" placeholder="Название изображения">
                            <small id="emailHelp" class="form-text text-muted">ID видео на youtube</small>
                        </div>
                        <div class="form-group">
